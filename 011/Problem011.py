''' 
  ...
  * 
  * Problem: Find the the greatest product of four adjacent numbers in the same
...
# vertical
current_product, highest_product = 0, 0
for y in xrange(17):
	for x in xrange(20):
...
for y in xrange(17):
	for x in xrange(17):
		...
		if current_product > highest_product:
			highest_product = current_product
		current_product = grid[y][x+3] * grid[y+1][x+2] * grid[y+2][x+1] * grid[y+3][x]
		if current_product > highest_product:
			highest_product = current_product
